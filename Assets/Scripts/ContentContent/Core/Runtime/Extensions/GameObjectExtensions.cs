...
namespace ContentContent
{
    ...
    public static class GameObjectExtensions
    {
        ...
        {
            foreach (Transform child in root.transform.EnumerateHierarchy()) child.gameObject.layer = layer;
        }

        /// <summary>
        ///     Set the layer to the given object and the full hierarchy below it and cache the previous layers in the out
        ///     parameter.
        /// </summary>
        /// <param name="root">Start point of the traverse</param>
        /// <param name="layer">The layer to apply</param>
        ...
        public static void SetLayerRecursively(this GameObject root, int layer, out Dictionary<GameObject, int> cache)
        {
            ...
            foreach (Transform child in root.transform.EnumerateHierarchy())
            {
        ...
        public static void ApplyLayerCacheRecursively(this GameObject root, Dictionary<GameObject, int> cache)
        {
            ...
            {
                GameObject childGameObject = child.gameObject;
                if (!cache.TryGetValue(childGameObject, out int layer)) continue;
        ...
        /// <summary>
        ///     Determines if a game object's layer is included in the specified layer mask.
        /// </summary>
        ...
        public static void ApplyToHierarchy(this GameObject root, Action<GameObject> action)
        {
            ...
            foreach (Transform item in items) action(item.gameObject);
        }
        ...
        /// <summary>
        ///     Sets the <see cref="Renderer" />s and optionally <see cref="Collider" />s in this <see cref="GameObject" /> to the
        ///     provided <see cref="bool" /> state.
        /// </summary>
        /// <remarks>
        ///     If the GameObject or it's children are inactive, they will be set active, but the GameObjects will not be set
        ///     inactive.
        /// </remarks>
        ...
        public static void SetRenderingActive(this GameObject gameObject, bool isActive, bool includeColliders = true)
        {
            ...
            foreach (Renderer renderer in gameObject.GetComponentsInChildren<Renderer>()) renderer.enabled = isActive;
#if UNITY_UGUI
        ...
        public static GameObject GetNearestGameObject(this GameObject gameObject, GameObject[] targets)
        {
